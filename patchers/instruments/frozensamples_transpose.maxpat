...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 157.0, 251.0, 26.0, 20.0 ],
					"style" : "",
					"text" : "ms"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 83.0, 251.0, 72.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 23.0, 37.0, 132.0, 20.0 ],
					"style" : "",
					"text" : "# 1/2 steps up or down"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 23.0, 222.0, 121.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 23.0, 61.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 23.0, 337.0, 121.0, 32.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 272.0, 222.0, 67.0, 22.0 ],
					"style" : "",
					"text" : "replace $1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 272.0, 188.0, 103.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 272.0, 106.0, 553.0, 66.0 ],
					"text" : "/file/name : \"Macintosh HD:/Users/jonathankulpa/Desktop/qbits_trajectory/ending/650_meta_res_posTowardsBegin_x+yPlay.aif\",\n/file/type : \"AIFF\""
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 272.0, 48.0, 115.0, 48.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "" ],
					"patching_rect" : [ 272.0, 255.0, 30.0, 22.0 ],
					"style" : "",
					"text" : "t 0 l"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 283.0, 299.0, 175.0, 22.0 ],
					"style" : "",
					"text" : "buffer~ transpose_this_sample"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 240.0, 347.0, 33.0, 22.0 ],
					"style" : "",
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 158.0, 347.0, 74.0, 22.0 ],
					"style" : "",
					"text" : "startwindow"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 23.0, 394.0, 37.0, 22.0 ],
					"style" : "",
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 23.0, 251.0, 33.0, 22.0 ],
					"style" : "",
					"text" : "sig~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 23.0, 299.0, 229.0, 22.0 ],
...
,
					"style" : "",
					"text" : "groove~ transpose_this_sample @loop 1"
				}
