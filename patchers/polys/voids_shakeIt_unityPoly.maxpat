...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 329.0, 172.0, 50.0, 22.0 ],
					"style" : "",
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 261.5, 281.5, 50.0, 22.0 ],
					"style" : "",
					"text" : "0.126"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 31.0, 237.0, 325.0, 22.0 ],
					"style" : "",
					"text" : "o.route /on /off /amp/global"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 479.125, 650.5, 19.0, 19.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 56.0, 103.0, 150.0, 34.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 133.0, 299.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 605.25, 579.5, 29.5, 22.0 ],
					"style" : "",
					"text" : "0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 42.666668, 382.0, 38.0, 20.0 ],
					"style" : "",
					"text" : "1. 200"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 31.0, 331.0, 54.0, 22.0 ],
					"style" : "",
					"text" : "t b b 0 b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 133.0, 382.0, 58.0, 20.0 ],
					"style" : "",
					"text" : "0. 800 -0.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 133.0, 331.0, 74.0, 22.0 ],
					"style" : "",
					"text" : "t b 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 56.125, 611.0, 64.0, 19.0 ],
					"style" : "",
					"text" : "global amp",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 443.125, 647.5, 34.0, 22.0 ],
					"style" : "",
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 400.125, 611.0, 77.0, 22.0 ],
					"style" : "",
					"text" : "curve~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 56.125, 647.5, 36.0, 19.0 ],
					"style" : "",
					"text" : "mute",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 31.125, 647.5, 388.0, 22.0 ],
					"style" : "",
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 31.125, 691.0, 44.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 227.0, 97.0, 55.0, 20.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 291.0, 97.0, 61.0, 22.0 ],
					"style" : "",
					"text" : "mute 1, 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 371.0, 97.0, 61.0, 22.0 ],
					"style" : "",
					"text" : "mute 0, 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 227.0, 172.0, 93.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 227.0, 138.0, 58.0, 22.0 ],
					"style" : "",
					"text" : "thispoly~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "FullPacket" ],
					"patching_rect" : [ 31.0, 208.5, 61.0, 22.0 ],
					"style" : "",
					"text" : "o.route /?"
				}
...
,
					"patching_rect" : [ 31.0, 537.0, 161.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 31.125, 611.0, 222.875, 22.0 ],
					"style" : "",
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 162.0, 299.0, 60.0, 29.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 66.0, 299.0, 43.0, 29.0 ],
					"style" : "",
					"text" : "started moving"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 31.0, 299.0, 24.0, 24.0 ],
					"style" : ""
				}
...
,
					"patching_rect" : [ 31.0, 571.0, 73.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-25", 0 ],
					"midpoints" : [ 75.5, 366.0, 575.0, 366.0, 575.0, 92.0, 380.5, 92.0 ],
					"source" : [ "obj-31", 3 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-58", 0 ],
					"midpoints" : [ 63.833333, 376.0, 452.625, 376.0 ],
					"source" : [ "obj-31", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 52.166668, 446.0, 409.625, 446.0 ],
					"source" : [ "obj-32", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-26", 0 ],
					"midpoints" : [ 598.75, 74.0, 300.5, 74.0 ],
					"source" : [ "obj-35", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-51", 0 ],
					"midpoints" : [ 142.5, 431.0, 409.625, 431.0 ],
					"source" : [ "obj-57", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.99567, 0.810297, 0.821758, 0.9 ],
					"destination" : [ "obj-26", 0 ],
					"midpoints" : [ 452.625, 678.0, 587.0, 678.0, 587.0, 82.0, 300.5, 82.0 ],
					"source" : [ "obj-58", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-58", 0 ],
					"midpoints" : [ 197.5, 421.0, 452.625, 421.0 ],
					"source" : [ "obj-59", 1 ]
				}
